...
required_names="APP_ENVIRONMENT SPRING_PROFILES_ACTIVE PHOKARTA_IMAGE PHOKARTA_RELEASE PHOKARTA_DOMAIN ACME_EMAIL PHOKARTA_DB_URL PHOKARTA_DB_USER PHOKARTA_DB_PASSWORD PHOKARTA_JWT_SECRET PHOKARTA_CORS_ALLOWED_ORIGINS PHOKARTA_PROFILE_PRIVACY_V2_ENABLED PHOKARTA_MEDIA_BUCKET PHOKARTA_MEDIA_REGION"
