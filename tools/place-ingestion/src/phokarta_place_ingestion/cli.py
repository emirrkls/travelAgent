...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "didim-autonomous":
        ...
        print(json.dumps({
            ...
            "source_record_states": result["summary"]["source_record_states"],
            "candidate_groups": result["summary"]["candidate_groups"],
            "candidate_decisions": result["summary"]["candidate_decisions"],
            "accounting_invariants": result["summary"]["accounting_invariants"],
